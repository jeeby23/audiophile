  ...
  return createPortal(
    <div className="fixed inset-0 z-50 bg-black/50 flex justify-center items-center p-4">
      ...
      <div className="relative z-50 bg-white rounded-lg shadow-lg w-full max-w-md p-8 flex flex-col gap-6 ">
        <Image src="/Groupsuc.png" alt="Success check" width={64} height={64} className="" />
        <div>
          ...
          <p className="text-gray-500 text-sm">You will receive an email confirmation shortly.</p>
        </div>

        <div className="flex flex-row items-stretch w-full">
          {/* Item List Container */}
          <div className="bg-[#F1F1F1] rounded-l-lg p-4 text-left flex-1">
          ...
          <div className="bg-black text-white p-4 rounded-r-lg flex flex-col justify-center items-start w-1/2">
